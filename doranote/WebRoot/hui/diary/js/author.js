...
//				$("#diarys").append("<br><br><center>"+call+"还没有喜欢的日记喔！</center><br><br>");
			...
			for(var i=0;i<res.length;i++){
				...
				$("#diarys").append("<div class=\"diary\" title='"+res[i].likeTime+"喜欢'><img src='http://img.duola.vip/image/tx/"+res[i].headImg+".jpg' class='touxiang'><span onclick='openOther(0,"+res[i].id+")'>"+con+"</span><br>"
...
//				$("#diarys").append("<br><br><center>"+call+"还没有收藏过日记喔！</center><br><br>");
			...
			for(var i=0;i<res.length;i++){
				...
				//分类
				var cate=getCateById(res[i].cate);
				$("#diarys").append("<div class=\"diary\" title='"+res[i].storeTime+"收藏'><img src='http://img.duola.vip/image/tx/"+res[i].headImg+".jpg' class='touxiang'><span onclick='openOther(0,"+res[i].id+")'>"+con+"</span><br>"
						+"<div class='info'><i class=\"Hui-iconfont\">&#xe60d;</i><span style='cursor:pointer' onclick='openOther(1,\""+res[i].writter+"\")'>"+res[i].u_User_Name
						+"</span>&emsp;<i class=\"Hui-iconfont\">&#xe690;</i>"+res[i].time
						+"&emsp;<i class=\"Hui-iconfont\">&#xe681;</i>"+cate+"&nbsp;:<span title='"+res[i].title+"'>《"+title+"》</span>&emsp;<i class=\"Hui-iconfont\">&#xe6c9;</i>"+res[i].loc
						+"<div class='zan'><i class=\"Hui-iconfont\">&#xe725;</i>"+res[i].visitNum+"&nbsp;<i class=\"Hui-iconfont\">&#xe622;</i><span id='commentNum'>"+res[i].commentNum+"</span>&nbsp;<i class=\"Hui-iconfont\">&#xe66d;</i><span>"+res[i].praiseNum
...
//					$("#diarys").append("<center>"+call+"共关注了<font color='red' size='2px'>"+data.length+"</font>个小伙伴</center>");
				...
				for(var i=0;i<data.length;i++){
					...
					$("#diarys").append("<div class='notice'><img src='http://img.duola.vip/image/tx/"+data[i].headImg+".jpg'><a href='author.html?author="+data[i].noticedId+"' target='_blank'>"+data[i].noticedName+"</a>&emsp;<font color='gray' size='1px'>"+data[i].fanNums+"粉丝</font>&emsp;<font  color='gray' size='1px'>"+data[i].joinDay+"天共"+data[i].diaryNum+"篇日记</font>"+btn+"<font color='gray' size='2px'><span>"+data[i].noticeTime+"</span></font></div><hr>");
				}
			}else{
				alert("查询失败");
			}
...
//					$("#diarys").append("<center>共<font color='red' size='2px'>"+data.length+"</font>个小伙伴关注了"+call+"</center>");
				...
				for(var i=0;i<data.length;i++){
					...
					$("#diarys").append("<div class='notice' style='cursor:pointer'><img src='http://img.duola.vip/image/tx/"+data[i].headImg+".jpg'><a href='author.html?author="+data[i].noticerId+"' target='_blank'>"+data[i].noticerName+"</a>&emsp;<font color='gray' size='1px'>"+data[i].fanNums+"粉丝</font>&emsp;<font color='gray' size='1px'>"+data[i].joinDay+"天"+data[i].diaryNum+"篇日记</font>"+btn+"<font color='gray' size='2px'><span>"+data[i].noticeTime+"</span></font></div><hr>");
