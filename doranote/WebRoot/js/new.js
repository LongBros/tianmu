	...
	if(type=='0'){
		...
		if(expre.indexOf("aodamiao") != -1){
			...
			for(var i=0;i<imgs.length;i++){
				$('#expre').append("<img alt='' src='http://img.duola.vip/image/expre/aodamiao/"+imgs[i]+".gif' onclick='appendValue(\"&&"+imgs[i]+"::\","+from+")'>");
			}
		}
	}else if(type=='1'){
		...
		if(expre.indexOf("huang") != -1){
			...
			for(var i=0;i<imgs.length;i++){
				$('#expre').append("<img alt='' src='http://img.duola.vip/image/expre/huang/"+imgs[i]+".gif' onclick='appendValue(\"&&&"+imgs[i]+"::\","+from+")'>");
			}
		}
	}else if(type=='2'){
		...
		if(expre.indexOf("aru") != -1){
			...
			var imgs=new Array("1","10","100","101","102","103","104","105","106","107","108","109"
		    		   ...
		    		   ,"17","18","19","2","20");
			for(var i=0;i<imgs.length;i++){
				$('#expre').append("<img alt='' src='http://img.duola.vip/image/expre/aru/"+imgs[i]+".png' onclick='appendValue(\"&&&"+imgs[i]+":::\","+from+")'>");
			}
		}
	}else if(type=='3'){
		...
		if(expre.indexOf("weibo") != -1){
			...
			for(var i=0;i<imgs.length;i++){
				$('#expre').append("<img alt='' src='http://img.duola.vip/image/expre/weibo/"+imgs[i]+".png' onclick='appendValue(\"&&&&"+imgs[i]+":::\","+from+")'>");
			}
		}
	}
}
