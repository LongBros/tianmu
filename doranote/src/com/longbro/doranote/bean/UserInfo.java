 ...
 * </pre>
 */
//2020-09-20 部分整型字段若不设初始值的话，在update时会按照0来，导致不该被更新却被更新，这里设为11，xml同时做下配置
public class UserInfo{
	...
	protected Integer uShowWordnum=11; //12-14日记列表是否显示日记字数
	...
	private Integer autoPlay=11;//自动播放带音频日记的音频(0:提示，1:自动播放，2:不播放) 
	private String lastLogin;//最近登录
	private String back;//网站背景2019-12-01
	private String mback;//2020-03-15移动端背景
	protected Integer perpageNum=11; //12-21默认每页加载多少篇(0：显示下拉列表，1：显示）
	private Integer inviter;//12-27	邀请者哆啦id
	private Integer showWhichTab=11;//12-27首页默认加载tab(0:推荐，1:关注，2:时间轴)
	...
	protected int listStyle=11;//2020-01-29日记列表显示样式(默认0:标题+部分内容，1:仅标题)
	protected int loopPlay=11;//2020-01-30音频是否循环播放 0:不循环，1:循环
	protected String dislikeDiary;//2020-03-15不喜欢的日记
	private Integer secretWall=11;//09-20 私密我的墙
	private Integer secretInteract=11;//09-20 私密互动信息
	private Integer secretAccount=11;
	private Integer defaultMood=11;//默认心情
	private Integer defaultWea=11;
	private Integer defaultCate=11;
	private Integer defaultAuth=11;
	private Integer showExpression=11;
	public Integer getShowExpression() {
		return showExpression;
	}
	public void setShowExpression(Integer showExpression) {
	...
	public int getSecretWall() {
		return secretWall;
	}
	public void setSecretWall(int secretWall) {
		this.secretWall = secretWall;
	}
	public int getSecretInteract() {
		return secretInteract;
	}
	public void setSecretInteract(int secretInteract) {
		this.secretInteract = secretInteract;
	}
	
	public Integer getSecretAccount() {
		return secretAccount;
	}
	public void setSecretAccount(Integer secretAccount) {
	...
	public Integer getDefaultMood() {
		return defaultMood;
	}
	public void setDefaultMood(Integer defaultMood) {
		this.defaultMood = defaultMood;
	}
	public Integer getDefaultWea() {
		return defaultWea;
	}
	public void setDefaultWea(Integer defaultWea) {
		this.defaultWea = defaultWea;
	}
