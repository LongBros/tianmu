...
//		    put("s", "inside_business");
	 ...
	 * @return
	 */
	public final static String httpPostMethodObject(String uri, Map<String, Object> paramMap) {
		// 生成参数字符串
		if (paramMap == null) {
			paramMap = new HashMap<String, Object>();
		}
		paramMap.putAll(defaultParam);
		final String param = createParamObject(paramMap);
	 ...
	 * @return a=1&b=2&c=3
	 */
	public static final String createParamObject(Map<String, Object> paramMap) {
		String param = "";
		if (paramMap != null && !paramMap.isEmpty()) {
			final StringBuffer buffer = new StringBuffer();
			for (String key : paramMap.keySet()) {
